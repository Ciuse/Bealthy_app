...
class SymptomsBarOld extends StatefulWidget {
  final DateTime day;
  SymptomsBarOld({@required this.day});

  @override
  _SymptomsBarOldState createState() => _SymptomsBarOldState();
}

class _SymptomsBarOldState extends State<SymptomsBarOld>{
